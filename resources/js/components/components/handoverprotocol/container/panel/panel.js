...
const Panel = ({ handoverProtocol, units }) => {
    return (
        <ul>
            <li key="1" className="row"><div className="col-2"><b>Z: </b></div><div className="col-10">{units.list.find(x => x.id == handoverProtocol.from).name}</div></li>
            <li key="2" className="row"><div className="col-2"><b>Do: </b></div><div className="col-10">{ units.list.find(x => x.id == handoverProtocol.to).name}</div></li>
